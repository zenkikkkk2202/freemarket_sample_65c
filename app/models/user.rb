class User < ApplicationRecord
  ...
  has_many :saling_items, -> { where("saler_id is not NULL && buyer_id is NULL") }, class_name: "Product"
  has_many :sold_items, -> { where("saler_id is not NULL && buyer_id is not NULL && auction_id is NULL") }, class_name: "Product"
  has_many :auction_items, -> { where("saler_id is not NULL && auction_id is not NULL && buyer_id is NULL") }, class_name: "Product"
