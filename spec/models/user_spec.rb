...
describe User do
  describe '#create' do
    #1.nicknameとemail、password,名前(全角),お名前カナ(全角),生年月日が存在すれば登録できること
  it "nicknameとemail、password,名前(全角),お名前カナ(全角),生年月日が存在すれば登録できること" do
    user = build(:user)
  ...
  #12. 生年月日を選択しなければ登録できない
  it "生年月日を選択しなければ登録できない" do
